...
function setThemeValue(css, prop, value, theme, config) {
	...
	iterateBreakpoints(css, theme, value, (mediaKey, valueFinal) => {
		...
		if (cssProperty === false) {
			if (mediaKey) fastDeepAssign(css[mediaKey], finalValue);
		...
		if (propName === "components" || propName === "slots") output[propName] = {
			...
			if (!slotProps) output[propName] = defaultSlotProps || {};
				...
				for (const slotKey in defaultSlotProps) if (Object.prototype.hasOwnProperty.call(defaultSlotProps, slotKey)) {
					...
					if (typeof defaultSlotPropValue === "function" || typeof slotPropValue === "function") output[propName][slotPropName] = (...args) => resolveProps((typeof defaultSlotPropValue === "function" ? defaultSlotPropValue(...args) : defaultSlotPropValue) ?? {}, (typeof slotPropValue === "function" ? slotPropValue(...args) : slotPropValue) ?? {}, mergeClassNameAndStyle);
					else output[propName][slotPropName] = resolveProps(defaultSlotPropValue ?? {}, slotPropValue ?? {}, mergeClassNameAndStyle);
				}
			}
		...
		Object.entries(object).forEach(([key, value]) => {
			if (!shouldSkipPaths || shouldSkipPaths && !shouldSkipPaths([...parentKeys, key])) {
				if (value !== void 0 && value !== null) {
					if (typeof value === "object" && Object.keys(value).length > 0) recurse(value, [...parentKeys, key], Array.isArray(value) ? [...arrayKeys, key] : arrayKeys);
...
function applyInsetFocusVisible(offset) {
	return {
...
//#endregion
export { css as $, alpha as A, rgbToHex as B, orange as C, common as D, grey as E, getLuminance as F, generateUtilityClasses as G, resolveProps as H, hexToRgb as I, createTheme$1 as J, generateUtilityClass as K, hslToRgb as L, decomposeColor as M, emphasize as N, DefaultPropsProvider as O, getContrastRatio as P, Global as Q, lighten as R, blue as S, purple as T, createStyled as U, clamp as V, preprocessStyles as W, internal_serializeStyles as X, createSpacing as Y, styled$1 as Z, applyChildrenFocusVisible as _, require_prop_types as _t, defaultTheme as a, styleFunctionSx_default as at, green as b, excludeVariablesFromRoot as c, getPath as ct, getOverlayAlpha as d, resolveBreakpointValues as dt, keyframes as et, createTransitions as f, createBreakpoints as ft, createMixins as g, clsx as gt, createTypography as h, capitalize as ht, identifier_default as i, StyleSheet as it, darken as j, useDefaultProps as k, shouldSkipGeneratingVar as l, handleBreakpoints as lt, easing as m, require_react_is$1 as mt, rootShouldForwardProp as n, ThemeContext as nt, createTheme as o, createUnarySpacing as ot, duration as p, deepmerge as pt, ClassNameGenerator as q, slotShouldForwardProp as r, createCache as rt, createThemeWithVars as s, getValue as st, styled as t, CacheProvider as tt, createColorScheme as u, mergeBreakpointsInOrder as ut, applyInsetFocusVisible as v, red as w, lightBlue as x, outsetFocusRing as y, recomposeColor as z };
